...
export const DataOfRoles: Readonly<Record<ERoles,Readonly<IDataOfRole>>> = {
  ...
  [ERoles.MONEY]:  {
    ...
    description: `
      ...
      Если догонишиь противника: +10 монет.
      За каждый домаг из лука: +20 монет.
      За каждый домаг от меча: +25 монет.
      За каждый домаг от яда: +15 монет.
      За каждое убийство: +70 монет.
    `,
  },
  [ERoles.SWORD]:  {
    name: 'Меч', 
